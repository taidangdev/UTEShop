...
export default function ProductCard({ product, onWishlistToggle }: ProductCardProps) {
    ...
    return (
        <Link to={`/products/${product.slug}`} className="group block relative">
            <article className="flex h-full flex-col overflow-hidden rounded-3xl bg-white shadow-[0_10px_30px_rgba(0,0,0,0.04)] transition-all duration-300 group-hover:shadow-[0_16px_40px_rgba(0,0,0,0.08)] group-hover:-translate-y-1">
                ...
                <div className="flex flex-1 flex-col gap-3 p-6">
                    ...
                    <h3 className="font-inter text-lg font-semibold leading-7 line-clamp-2" style={{ color: TEXT }}>
                        {product.name}
                    </h3>
                    ...
                    <div className="mt-auto flex items-center justify-between pt-2">
                        <div className="flex items-baseline gap-2">
                            <p className="font-inter text-2xl font-bold" style={{ color: TEXT }}>
